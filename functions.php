<?php
/**
 * ShareAtelierBambi functions and definitions
 *
...
if ( ! function_exists( 'sab_setup' ) ) :
	...
	function sab_setup() {
		 ...
		 * If you're building a theme based on ShareAtelierBambi, use a find and replace
		 * to change 'sab' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'sab', get_template_directory() . '/languages' );
 ...
 */
function sab_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'sab' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'sab' ),
...
add_action( 'widgets_init', 'sab_widgets_init' );
